...
{return (function() { 
var G__5294__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__5297 = o;(G__5297[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5297;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5298){var vec__5300 = p__5298;var id = cljs.core.nth.call(null,vec__5300,(0),null);var class$ = cljs.core.nth.call(null,vec__5300,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5301 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5301 === "key")))
{(o[pname_5301] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5304 = jsprops;(G__5304["defaultValue"] = value);
(G__5304["value"] = null);
(G__5304["onChange"] = ((function (G__5304,on_change,value){
return (function (p1__5302_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5302_SHARP_);
});})(G__5304,on_change,value))
);
return G__5304;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__5306 = spec;(G__5306["componentDidUpdate"] = ((function (G__5306){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__5306))
);
(G__5306["componentWillUnmount"] = ((function (G__5306){
...
return (function (p1__5307_SHARP_,p2__5308_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__5307_SHARP_,p2__5308_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5310 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5310,(0),null);var id = cljs.core.nth.call(null,vec__5310,(1),null);var class$ = cljs.core.nth.call(null,vec__5310,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5312 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5312,(0),null);var id_class = cljs.core.nth.call(null,vec__5312,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_5313 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5314 = (((k_5313 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5313);if((k_SINGLEQUOTE__5314 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5314);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___5315 = a.length;var i_5316 = (0);while(true){
if((i_5316 < n__4510__auto___5315))
{(a[i_5316] = reagent.impl.template.as_component.call(null,(a[i_5316]),level_SINGLEQUOTE_));
{
var G__5317 = (i_5316 + (1));
i_5316 = G__5317;
continue;
}
} else
